let handler = async (m, { conn, groupMetadata }) => {
    ...
    if (warning < 2) {
        ...
        m.reply(`⚠️ *WARNING +1*`)
        m.reply('Kamu mendapatkan warn dari admin, total warn kamu sekarang *' + (warning + 1) + '* warn, Jika kamu mendapat warn *3 kali*, kamu akan dikeluarkan dari grup', mention)
    } else if (warn == 2) {
