...
exports.smsg = (conn, m, hasParent) => {
  ...
  if (m.message) {
    ...
    m.reply = (teks) => {
conn.reply(m.chat, teks, MessageType, { thumbnail: fs.readFileSync('./logonya.jpg'), sendEphemeral: true, quoted: m, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: `KTDPRJCT メ Bo†`,body:"SELECT",previewType:"PHOTO",thumbnail:fs.readFileSync('./logonya2.png'),sourceUrl:`https://chat.whatsapp.com/L91Hwo4hUh323SwlFvCemw`}}})
}
    /**
     * Copy this message
     */
